...
const Wrapper = styled.div`
  padding: 20px;
   @media only screen and (max-width: 500px){ padding: 10px;}
`;
...
const ProductAmount = styled.div`
  font-size: 24px;
  margin: 5px;
   @media only screen and (max-width: 500px){ margin: 5px 15px}
  `;

const ProductPrice = styled.div`
  font-size: 30px;
  font-weight: 200;
   @media only screen and (max-width: 500px){ margin-bottom: "20px"}  
`;
