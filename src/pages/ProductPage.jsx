...
const Wrapper = styled.div`
  padding: 50px;
  display: flex;
   @media only screen and (max-width: 412px){ padding: 10px; flex-direction: column;}
`;
...
const Image = styled.img`
  ...
  height: 90vh;
  object-fit: cover;
   @media only screen and (max-width: 412px){ height: 40vh;}
`;
...
const FilterContainer = styled.div`
  ...
  justify-content: space-between;
   @media only screen and (max-width: 412px){ width: 100%;}
`;
